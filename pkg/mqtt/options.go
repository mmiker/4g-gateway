...
type MessageHandler func(Client, Message, ...interface{})
...
type ConnectionLostHandler func(Client, error, ...interface{})
...
type OnConnectHandler func(Client, ...interface{})

// ReconnectHandler is invoked prior to reconnecting after
// the initial connection is lost
type ReconnectHandler func(Client, *ClientOptions, ...interface{})
